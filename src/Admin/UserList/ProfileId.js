                                                ...
                                                <div className="contact-info-list">
                                                    ...
                                                    <div className="edu-wrap">
                                                        ...
                                                        <div className="edu-detail">
                                                            ...
                                                            <p>
                                                                {" "}
                                                                <Link  target="_blank" to={`tel:${listing?.user?.phone_number}`}>{listing?.user?.phone_code} {listing?.user?.phone_number}</Link>
                                                            </p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="edu-wrap">
                                                        ...
                                                        <div className="edu-detail">
                                                            ...
                                                            <p>
                                                                <Link target="_blank" to={`https://wa.me/${listing?.profile?.phone_number}?text=${encodeURIComponent("hello")}`}>{listing?.user?.phone_code} {listing?.profile?.phone_number}</Link>
                                                            </p>
                                                        </div>
                                                    </div>
